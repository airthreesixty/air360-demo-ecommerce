            ...
            <div class="footer__widget mb-30">
              ...
              <div class="footer__widget-content">
                ...
                <div class="form-group">
                  <input id="newsletter-input" class="form-control" type="email" name="contact[email]" placeholder="Your email address...">
                  <button class="ss-btn btnNewsletter" type="submit">
                    Subscribe
                  </button>
                </div>
              </div>
