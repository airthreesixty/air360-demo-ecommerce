<template>
  <div :id="`${list ? `productModalListId-${item.id}` : `productModalId-${item.id}`}`" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="row">
              <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-12">
                <div class="product__modal-box">
                  <div id="nav-tabContent" class="tab-content mb-20">
